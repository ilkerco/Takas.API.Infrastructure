...
{
    public partial class StartforChat : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestedProductId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chats_Product_SuggestedProductId",
                        column: x => x.SuggestedProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Chats_Product_TargetProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chats_SuggestedProductId",
                table: "Chats",
                column: "SuggestedProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Chats_TargetProductId",
                table: "Chats",
