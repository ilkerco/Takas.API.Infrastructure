...
{
    [DbContext(typeof(TakasDbContext))]
    [Migration("20210706134202_StartforChat")]
    partial class StartforChat
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Takas.Core.Model.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Takas.Core.Model.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Takas.Core.Model.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Takas.Core.Model.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Takas.Core.Model.Entities.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Takas.Core.Model.Entities.User", b =>
                {
                    b.HasOne("Takas.Core.Model.Entities.Chat", null)
                        .WithMany("Users")
                        .HasForeignKey("ChatId");
                });
